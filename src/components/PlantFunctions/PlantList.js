...
const ProductList = () => {
    ...
    useEffect(() => {
        const filtered = productsList.filter(product => product.name.toLowerCase().includes(searchQuery.toLowerCase()) && product.rating >= ratingFilter);
        setFilteredProducts(filtered);
    }, [productsList, searchQuery, ratingFilter]);
        ...
        <div className="py-10 relative overflow-hidden bg-gradient-to-b from-green-100 to-purple-100 font-poppins">
            ...
            <div className="relative z-10">
                ...
                <div className="flex justify-center mb-4">
                    <input type="search" value={searchQuery} onChange={handleSearch} placeholder="Search products" className="w-1/2 py-2 pl-10 text-sm text-gray-700" />
                    <select value={ratingFilter} onChange={handleRatingFilter} className="ml-4 py-2 pl-10 text-sm text-gray-700">
